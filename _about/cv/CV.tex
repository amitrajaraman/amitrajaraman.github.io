...
% Default biblatexx style used for the publication list is APA6. If you wish to use a different style or pass other options to biblatex you can change them here. 
\PassOptionsToPackage{style=ieee,sorting=ddnt,uniquename=init,defernumbers=true}{biblatex}
...
\leftheader{
  ...
  \makefield{\faEnvelope[regular]}{\href{mailto:amit\_r@mit.edu}{\texttt{amit\_r@mit.edu}}} \\
